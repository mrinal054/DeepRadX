...
class ResNet50Pscse(nn.Module):
    def __init__(self,
        ...
        super(ResNet50Pscse, self).__init__()

        self.clipped_model = ResNet50_Upto_256x28x28()
...
if __name__ == "__main__":
    ...
    model = ResNet50Pscse(num_classes, out_channels, dropout, activation, reduction)
