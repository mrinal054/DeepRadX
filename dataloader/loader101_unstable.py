...
"""
v101: experimenting with normalization -- not stable yet
"""
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Normalize
        im = normalize_numpy(im, a=0.0, b=1.0) # normalize between [0,1]
        if self.normalize: im = self.normalize(image=im)['image'] # standardize
