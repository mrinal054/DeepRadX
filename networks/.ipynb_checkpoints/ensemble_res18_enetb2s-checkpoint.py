...
class EnsembleRes18Enetb2s(nn.Module):
    def __init__(self, 
                 num_classes,
                 out_channels:list=None, # for instance [1024, 512, 256]. Used in classification head
                 dropout:float=0.3,
                ):
        super(EnsembleRes18Enetb2s, self).__init__()
...
if __name__ == "__main__":
    ...
    dropout = 0.3
    model = EnsembleRes18Enetb2s(num_classes=num_classes, out_channels=out_channels, dropout=dropout)
