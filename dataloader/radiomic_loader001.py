...
class MyDataset(Dataset):
    def __init__(self, 
        ...
        self.concat = concat
        self.radiomic_feature_names:list = radiomic_feature_names 
        self.radiomic_dataframe:list = radiomic_dataframe
    ...
    def __getitem__(self, index):
        ...
        if self.radiomic_feature_names is not None:
            store_radiomic_features = []
            # for r_dataframe in self.radiomic_dataframe:
            #     for r_feature_names in self.radiomic_feature_names:

            for r_dataframe, r_feature_names in zip(self.radiomic_dataframe, self.radiomic_feature_names):
                ...
                radiomic_name = r_dataframe["Base names"].iloc[index] 
                ...
                radiomic_features = [r_dataframe.iloc[index][name] for name in r_feature_names]
                ...
                store_radiomic_features.append(radiomic_features)

            collective_radiomic_features = torch.cat(store_radiomic_features, dim=1)
        
            return im, collective_radiomic_features, y, name # tensors
